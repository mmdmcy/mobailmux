...
- For the built-in web UI, set a strong `MOBAILMUX_WEB_PASSWORD`.
...
- Do not expose the web UI or Mattermost directly to the public internet unless you add a proper access layer.
